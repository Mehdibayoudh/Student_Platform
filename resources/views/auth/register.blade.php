                        ...
                        <div class="p-2 mt-4">
                            <form action="{{ route('register') }}" method="POST">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="email" class="form-control" id="useremail" name="email" placeholder="Enter email address" value="{{ old('email') }}" required>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="password" class="form-control pe-5 password-input" id="password-confirmation" name="password_confirmation" required>
